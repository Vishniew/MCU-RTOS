...
typedef struct
{
	...
	uint8_t GPIO_PinSpeed;			/*<Possible values from @GPIO_PIN_SPPED>*/
...
typedef struct
{
	GPIO_RegDef_t *pGPIOx; 				//It holds the base address of GPIO port to which the pin belongs
	GPIO_PinConfig_t GPIO_PinConfig;	//It holds the GPIO pin configuration settings
}GPIO_Handle_t;
